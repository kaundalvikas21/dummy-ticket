...
export function SettingsView() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      try {
        const notifyResponse = await fetch('/api/auth/profile/password-changed', {
          method: 'POST',
        })
        ...
        console.error('Error notifying password change:', notifyError)
        // Non-blocking error, user password is changed successfully
      }
            ...
            <div className="relative h-full min-h-[400px] rounded-xl overflow-hidden shadow-2xl ring-1 ring-gray-200">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                  <p className="text-white font-medium">Keep your account secure</p>
                  <p className="text-white/80 text-sm">A strong password helps protect your personal information and booking details.</p>
                </div>
              </div>
            </div>
          </div>
