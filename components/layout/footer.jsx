...
export function Footer() {
  ...
  const data = loading ? fallbackData : {
    ...
    company_links: (footerData.company_links || []).filter(link => link.visible !== false),
    support_links: (footerData.support_links || []).filter(link => link.visible !== false),
    contact_items: (footerData.contact_items || []).filter(item => item.visible !== false),
    social_links: (footerData.social_links || []).filter(social => social.visible !== false)
  }
