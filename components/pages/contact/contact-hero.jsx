  ...
  return (
    <section className="relative pt-24 pb-12 md:pt-32 md:pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0066FF]/50 to-[#0066FF]/50" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6">Get in Touch</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            ...
            >
              ...
              <p className="text-white/80 text-xs md:text-sm">24/7 Support Available</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80 text-xs md:text-sm">Quick Response Time</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80 text-xs md:text-sm">Global Presence</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
