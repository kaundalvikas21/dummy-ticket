                ...
                {service.popular_label && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
                    <span className="bg-gradient-to-r from-[#0066FF] to-[#00D4AA] text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg">
                      {service.popular_label.toUpperCase()}
                    </span>
                  </div>
                )}
                    ...
                    <div className="absolute bottom-3 left-3 z-20">
                      ...
                      >
                        {ServiceIcon && (<ServiceIcon
                          className={`w-6 h-6 ${service.popular_label ? "text-white" : "text-[#0066FF]"}`}
                        />)}
                      </div>
                    </div>
                  </div>
                    ...
                    <ul className="space-y-2 mt-3">
                      {service.features.map((feature, i) => (
                        <li key={i} className="flex items-start gap-2">
                          <CheckCircle2
                            className={`w-4 h-4 flex-shrink-0 ${service.popular_label ? "text-[#0066FF]" : "text-[#00D4AA]"
                              }`}
                          />
