...
export function FAQ() {
  ...
  return (
    <section
      id="faq"
      ref={ref}
      className="py-12 md:py-24 bg-gradient-to-b from-blue-50 to-white"
    >
              ...
              >
                <div className="bg-white/60 backdrop-blur-lg rounded-2xl shadow-lg border border-white/50 overflow-hidden">
                  <button
                    ...
                    className="w-full px-4 py-4 md:px-8 md:py-6 flex items-center justify-between text-left hover:bg-white/40 transition-colors"
                  >
                    <span className="font-semibold text-gray-900 text-sm md:text-lg pr-4 md:pr-8">
                      {faq.question}
                    </span>
                    <ChevronDown
                      className={`w-5 h-5 md:w-6 md:h-6 text-[#0066FF] flex-shrink-0 transition-transform duration-300 ${
                  ...
                  >
                    <div className="px-4 pb-4 md:px-8 md:pb-6 text-gray-600 leading-relaxed text-sm md:text-base">
                      {faq.answer}
                    </div>
                  </motion.div>
                </div>
            ...
            <div className="sticky top-24">
              <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-4 md:p-6 shadow-xl border border-white/50">
                ...
                <p className="text-gray-700 text-xs md:text-sm leading-relaxed mb-4 md:mb-6">
                  Join our affiliate program and earn 15% commission by
                  referring customers. Perfect for travel bloggers, visa
                ...
                <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                  <div className="flex items-center justify-between p-2.5 md:p-3 bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl">
                    ...
                    <span className="text-base md:text-lg font-bold text-[#0066FF]">
                      15%
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2.5 md:p-3 bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl">
                    ...
                    <span className="text-base md:text-lg font-bold text-[#00D4AA]">
                      30 days
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2.5 md:p-3 bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl">
                ...
                <Link href="/target-page">
                  <Button className="w-full py-4 md:py-6 rounded-xl font-semibold bg-gradient-to-r from-[#0066FF] to-[#00D4AA] text-white hover:shadow-xl hover:shadow-[#0066FF]/30 transition-all group text-sm md:text-base cursor-pointer">
                    Join Now
