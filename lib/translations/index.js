...
import frServicesTranslations from '../../lang/fr/services.json';
import nlServicesTranslations from '../../lang/nl/services.json';
import esServicesTranslations from '../../lang/es/services.json';
import arServicesTranslations from '../../lang/ar/services.json';
...
// Import FAQ page translations
import enFaqPageTranslations from '../../lang/en/faqPage.json';
import frFaqPageTranslations from '../../lang/fr/faqPage.json';
import nlFaqPageTranslations from '../../lang/nl/faqPage.json';
import esFaqPageTranslations from '../../lang/es/faqPage.json';
import arFaqPageTranslations from '../../lang/ar/faqPage.json';

// Import Terms of service page translations
import enTermsTranslations from '../../lang/en/terms.json';
import frTermsTranslations from '../../lang/fr/terms.json';
import nlTermsTranslations from '../../lang/nl/terms.json';
import esTermsTranslations from '../../lang/es/terms.json';
import arTermsTranslations from '../../lang/ar/terms.json';

// Import Privacy policy page translations
import enPrivacyTranslations from '../../lang/en/privacy.json';
import frPrivacyTranslations from '../../lang/fr/privacy.json';
import nlPrivacyTranslations from '../../lang/nl/privacy.json';
import esPrivacyTranslations from '../../lang/es/privacy.json';
import arPrivacyTranslations from '../../lang/ar/privacy.json';

// Import Blog page translations
import enBlogTranslations from '../../lang/en/blog.json';
...
const translationFiles = {
  en: {
    ...
    faqPage: enFaqPageTranslations,
    // Terms page translations
    terms: enTermsTranslations,
    // Privacy page translations
    privacy: enPrivacyTranslations,
  ...
  fr: {
    ...
    services: frServicesTranslations,
    about: frAboutTranslations,
    contact: frContactTranslations,
    faqPage: frFaqPageTranslations,
    terms: frTermsTranslations,
    privacy: frPrivacyTranslations,
  },
  nl: {
    homepage: nlHomepageTranslations,
    buyTicket: nlBuyTicketTranslations,
    services: nlServicesTranslations,
    about: nlAboutTranslations,
    contact: nlContactTranslations,
    faqPage: nlFaqPageTranslations,
    terms: nlTermsTranslations,
    privacy: nlPrivacyTranslations,
  },
  es: {
    homepage: esHomepageTranslations,
    buyTicket: esBuyTicketTranslations,
    services: esServicesTranslations,
    about: esAboutTranslations,
    contact: esContactTranslations,
    faqPage: esFaqPageTranslations,
    terms: esTermsTranslations,
    privacy: esPrivacyTranslations,
  },
  ar: {
    homepage: arHomepageTranslations,
    buyTicket: arBuyTicketTranslations,
    services: arServicesTranslations,
    about: arAboutTranslations,
    contact: arContactTranslations,
    faqPage: arFaqPageTranslations,
    terms: arTermsTranslations,
    privacy: arPrivacyTranslations,
  },
};
...
export function useTranslation(namespace = null) {
  ...
  const t = (key, options = {}) => {
    // Determine the full path based on whether a namespace is provided
    ...
    if (locale !== 'en' && translationCache.has('en')) {
      ...
      if (englishValue !== null) {
        console.warn(`Missing translation for key "${path}" in locale "${locale}", using English fallback`);
        return englishValue;
      }
    }

    // If no translation found, return fallback or key
    console.warn(`Translation not found for key "${path}" in any locale`);
