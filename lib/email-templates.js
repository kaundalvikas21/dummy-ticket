    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="route">
                ...
                <div class="route-cities">${formatLocation(p.departureCity)} ${p.returnDate ? '⇄' : '→'} ${formatLocation(p.arrivalCity)}</div>
            ...
            <div class="booking-card">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr style="border-bottom: 1px solid #e9ecef;">
                        <td style="padding: 12px 0; font-weight: 600; color: #495057; font-size: 14px;">Email</td>
                        <td style="padding: 12px 0; color: #212529; font-size: 14px; text-align: right;">${p.deliveryEmail || p.email}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #e9ecef;">
                    ...
                    <tr>
                        <td style="padding: 12px 0; font-weight: 600; color: #495057; font-size: 14px;">Service Type</td>
                        <td style="padding: 12px 0; color: #1e40af; font-size: 14px; text-align: right; font-weight: 700;">${booking.service_plan_name || booking.type || 'Standard Ticket'}</td>
                    </tr>
                    <tr>
...
<head>
    ...
    <style>
        ...
        .feature-item { display: flex; align-items: center; margin-bottom: 15px; color: #495057; font-size: 14px; }
...
<head>
    ...
    <style>
        ...
        .info-table th { text-align: left; padding: 10px; background: #f8f9fa; border-bottom: 1px solid #eee; width: 30%; }
...
<body>
    <div class="container">
        <div class="header">
            <h2 style="margin: 0; color: #667eea;">New User Registration</h2>
        </div>
        ...
        <div style="margin-top: 30px; text-align: center;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || '#'}/admin/customers" style="background: #667eea; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">View in Admin Panel</a>
        </div>
...
<head>
    ...
    <style>
        ...
        .info-table { width: 100%; border-collapse: collapse; }
        .info-table th { text-align: left; padding: 12px; background: #f8f9fa; border-bottom: 1px solid #eee; width: 35%; color: #444; font-size: 14px; }
        .info-table td { padding: 12px; border-bottom: 1px solid #eee; font-size: 14px; color: #212529; }
        .status-badge { background: #d4edda; color: #155724; padding: 4px 10px; border-radius: 4px; font-size: 12px; font-weight: bold; text-transform: uppercase; }
        .footer { margin-top: 20px; font-size: 12px; color: #666; text-align: center; }
        .btn-container { text-align: center; margin-top: 30px; }
        .btn { background: #764ba2; color: white !important; padding: 12px 25px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 14px; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <p style="font-size: 15px;">A new booking has been completed on <strong>${appName}</strong>.</p>
...
<head>
    ...
    <style>
        ...
        .greeting { font-size: 18px; color: #333; margin-bottom: 20px; }
        .message { font-size: 16px; color: #666; line-height: 1.6; margin-bottom: 30px; }
        .alert-box { background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; border-radius: 8px; padding: 15px; margin-bottom: 20px; font-size: 14px; }
        .footer { background: #f8f9fa; padding: 30px; text-align: center; color: #6c757d; font-size: 14px; }
        .btn { display: inline-block; background: #667eea; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="container">
