            ...
            <div ref={acknowledgmentRef} style={PDF_STYLES.container}>
                ...
                <div style={PDF_STYLES.header}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                        <p style={{ margin: '0', fontSize: '12px', color: '#64748b' }}>Date: {format(new Date(booking.created_at), "PPP")}</p>
                ...
                <div style={PDF_STYLES.grid2}>
                    <div style={PDF_STYLES.card}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                            <div style={PDF_STYLES.fieldGroup}>
                                ...
                                <p style={PDF_STYLES.fieldValue}>{p?.firstName} {p?.lastName}</p>
                            </div>
                            <div style={PDF_STYLES.fieldGroup}>
                                <p style={PDF_STYLES.fieldLabel}>Passenger Email</p>
                                <p style={{ ...PDF_STYLES.fieldValue, fontSize: '12px' }}>{p?.deliveryEmail || p?.email}</p>
                            </div>
                            <div style={PDF_STYLES.fieldGroup}>
                    ...
                    <div style={PDF_STYLES.card}>
                        ...
                        <div style={PDF_STYLES.fieldGroup}>
                            ...
                            <p style={{ fontSize: '11px', fontWeight: '600', fontFamily: 'monospace', color: '#475569', margin: '4px 0 0 0' }}>{booking.payment_intent_id}</p>
                        </div>
